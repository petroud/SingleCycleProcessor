...
REM
REM Generated by Vivado on Sat Mar 12 21:58:56 +0200 2022
...
echo "xvhdl --incr --relax -prj rf_tb_vhdl.prj"
call xvhdl  --incr --relax -prj rf_tb_vhdl.prj -log xvhdl.log
