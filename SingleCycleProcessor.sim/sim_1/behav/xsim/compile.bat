...
REM
REM Generated by Vivado on Thu Apr 07 05:51:10 +0300 2022
...
echo "xvhdl --incr --relax -prj proc_sc_tb_vhdl.prj"
call xvhdl  --incr --relax -prj proc_sc_tb_vhdl.prj -log xvhdl.log
